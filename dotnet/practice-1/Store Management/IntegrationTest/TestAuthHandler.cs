...
namespace IntegrationTest
{
    public class TestAuthHandlerOptions : AuthenticationSchemeOptions
    {
        ...
        public string DefaultUserRole { get; set; } = null!;
    ...
    public class TestAuthHandler : AuthenticationHandler<TestAuthHandlerOptions>
    {
            ...
            ISystemClock clock) : base(options, logger, encoder, clock)
        {
            ...
            _defaultUserRole = options.CurrentValue.DefaultUserRole;
        }
        ...
        protected override Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            if (Context.Request.Headers.TryGetValue(UserId, out var userId))
            {
                ...
                claims.Add(new Claim("id", userId[0]));
            }
            else
            {
                claims.Add(new Claim(ClaimTypes.NameIdentifier, _defaultUserId));
                claims.Add(new Claim("id", _defaultUserId));
            }

            claims.Add(new Claim("email", "admin@gmail.com"));
